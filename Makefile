...
$(BUILD_DIR)/m_fcfs.o: $(MULTI_CPU_SCHEDULER)/m_fcfs.c $(MULTI_CPU_SCHEDULER)/m_fcfs.h $(MULTI_CPU_SCHEDULER)/m_queue.h $(MULTI_CPU_SCHEDULER)/m_pcb.h  $(SCHEDULER)/pcb.h
